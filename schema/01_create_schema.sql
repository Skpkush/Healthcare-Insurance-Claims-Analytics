-- ============================================================
-- Star Schema DDL — Healthcare & Insurance Claims Analytics
-- Author  : Sumit Prajapat
-- Database: PostgreSQL 16
-- Tables  : dim_date, dim_patients, dim_providers,
--           dim_policies, fact_claims
-- ============================================================
...
-- CSV columns: claim_id,patient_id,provider_id,policy_id,date_key,diagnosis_code,
--              diagnosis_name,treatment_type,claim_amount,approved_amount,status,
--              rejection_reason,settlement_days,length_of_stay,is_emergency,is_readmission
-- ============================================================
CREATE TABLE fact_claims (
    ...
    settlement_days     INT,
    length_of_stay      INT,
    is_emergency        INT,   -- 1 = Yes, 0 = No
    is_readmission      INT    -- 1 = Yes, 0 = No
);
